...
public class NumismaticTransaction implements Transaction {
    ...
    public NumismaticTransaction(double delta, Currency currency, User user, String message, Response response, Type type) {
        this.delta = delta;
